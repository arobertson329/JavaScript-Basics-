...
if (temperature >=80 && rain == true) {
  console.log ('One sholud wear a t-shirt and take an umbrella.')
} 
else if (temperature >=60 && temperature <80 && rain == true) {
  console.log ('One should wear a rain-jacket and carry an umbrella.')
}
else if (temperature <=60 && rain == true) {
  console.log ('One should wear a large rain-jacket and carry an umbrella.')
}
else if (temperature >=80 && rain == false) {
  console.log ('Wear a t-shirt and leave the umbrella.')
}
else if (temperature <=80 && rain == false) {
  console.log ('One should wear a jacket and leave the umbrella.')
}
////////// PROBLEM 5 //////////
